...
GL_VERSION_ES_CM_1_0          = true;
GL_VERSION_ES_CL_1_0          = true;
GL_VERSION_ES_CM_1_1          = true;
GL_VERSION_ES_CL_1_1          = true;
...
GL_OES_point_size_array = true;
ffi.cdef[[
void glPointSizePointerOES (GLenum type, GLsizei stride, const GLvoid *pointer);
]]

-- GL_OES_point_sprite 
GL_OES_point_sprite = true;

-- OES_read_format 
if not GL_OES_read_format then
GL_IMPLEMENTATION_COLOR_READ_TYPE_OES                   = 0x8B9A
GL_IMPLEMENTATION_COLOR_READ_FORMAT_OES                 = 0x8B9B
end

-- GL_OES_compressed_paletted_texture 
if not GL_OES_compressed_paletted_texture then
...
if not GL_OES_point_size_array then
...
-- GL_OES_point_sprite 
if not GL_OES_point_sprite then
